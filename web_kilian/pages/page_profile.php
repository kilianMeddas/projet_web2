...
<body>
    <div class="text-background">
        ...
        <nav>
            ...
            <?php if (isset($_SESSION['editing']['name'])): ?>
                <form method="post">
                    <label for="name"><span class="material-symbols-outlined">id_card</span></label>
                    <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($_SESSION['name']); ?>">
                    <input type="hidden" name="field" value="name">
                    <input type="submit" value="Enregistrer">
                    <button type="submit" name="annuler" value="name">Annuler</button>
                </form>
            ...
            <?php else: ?>
                <p class="output">
                <label for="name"><span class="material-symbols-outlined">id_card</span></label><?php echo htmlspecialchars($_SESSION['name']); ?>
                    <form method="post" style="text-align: center;">
                        <input type="hidden" name="modifier" value="name">
